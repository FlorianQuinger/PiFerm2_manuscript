...
#SBATCH --mem=500g
#SBATCH --job-name=051_gtdbtk
#SBATCH --output=logs/051_gtdbtk.out
#SBATCH --error=logs/051_gtdbtk.err
...
TG=00_data/05_taxonomy_gtdbtk
OUT=02_report/05_gtdbtk
...
gtdbtk classify_wf --genome_dir $BR --out_dir $TG --cpus 32 -x fna --skip_ani_screen #skipping screening step to get all protein alignments
